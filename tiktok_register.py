...
https://p19-rc-captcha-sg.ibyteimg.com/tos-alisg-i-749px8mig0-sg/3d_2385_de5e86b6249ac023fd918614e1922410cc46e093_1.jpg~tplv-749px8mig0-2.jpeg
'''
...
# time.sleep(15)
# print(icon_img.location)
# print(icon_img.size)
# icon_img.screenshot('verification_code/{}'.format(img_name.group(1)))
# time.sleep(10)
# action = ActionChains(driver)
# action.move_to_element_with_offset(icon_img,0,0).click().perform()
#
# time.sleep(100)
# driver.close()
# exit(11)
